...
namespace StackExchangeRedisDemo
{
    ...
    public static class StackExchangeRedisHelper
    {
        ...
        {
            LogHelper.LogInformation("Configuration changed: " + e.EndPoint);
        }
        /// <summary>
        /// 发生错误时
        /// </summary>
        ...
        {
            Microsoft.IdentityModel.Logging.LogHelper.LogInformation("ErrorMessage: " + e.Message);
        }
        /// <summary>
        /// 重新建立连接之前的错误
        /// </summary>
        ...
        {
            LogHelper.LogInformation("ConnectionRestored: " + e.EndPoint);
        }
        /// <summary>
        ...
        {
            LogHelper.LogInformation("重新连接：Endpoint failed: " + e.EndPoint + ", " + e.FailureType + (e.Exception == null ? "" : (", " + e.Exception.Message)));
        }
        /// <summary>
        /// 更改集群
        /// </summary>
        ...
        {
            LogHelper.LogInformation("HashSlotMoved:NewEndPoint" + e.NewEndPoint + ", OldEndPoint" + e.OldEndPoint);
        }
        /// <summary>
        /// redis类库错误
        /// </summary>
        ...
        {
            LogHelper.LogInformation("InternalError:Message" + e.Exception.Message);
        }
